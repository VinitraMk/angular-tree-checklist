...
export class TreeComponent implements OnChanges {
  ...
  constructor() {
    ...
    this.allNodes = this.treeControl.dataNodes.map((x) => ({
      id: x.id,
      name: x.item,
      checked: this.checklistSelection.isSelected(x),
    }));
    // database.dataChange.subscribe((data) => {
    //   console.log('data base change');
    //   this.dataSource.data = data;
    // });
  }

  ngOnChanges() {
    console.log('changes in tree', this.flatNodes);
    this.setNodeSelection(this.flatNodes);
  }

  setNodeSelection(flatNodes: any[]) {
    this.treeControl.dataNodes.forEach((x, i) => {
      if (flatNodes[i].checked) {
  ...
  ngOnInit() {
    this.onCheckboxChange.emit(this.treeControl.dataNodes);
  }
  ...
  todoItemSelectionToggle(node: TodoItemFlatNode): void {
    ...
    this.onCheckboxChange.emit(
      this.treeControl.dataNodes.map((x) =>
        Object.assign({}, x, {
          checked: this.checklistSelection.isSelected(x),
        })
      )
